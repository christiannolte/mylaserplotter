...
{
       0,     0,     3,     6,     8,    15,    20,    23,    26,    29
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      13,     0,    -1,    13,    14,    -1,    14,    -1,     5,     3,
       7,     3,     8,     3,    -1,    10,     3,    11,     3,    -1,
       9,     3,    -1,     5,     3,    -1,     6,     3,    -1,     4,
      -1
};
...
{
  "$end", "error", "$undefined", "NUMBER", "NEWLINE", "G", "M", "X", "Y",
  "F", "I", "J", "$accept", "kommandos", "kommando", 0
};
#endif
...
{
      12,     8,     9,    14,     1,     2,     3,    10,    11,     4,
       5,     1,     2,     3,    15,    16,     4,     5,    17,    18,
      19,     0,    13
};
...
{
       0,     4,     5,     6,     9,    10,    13,    14,     3,     3,
       3,     3,     0,    14,     7,    11,     3,     3,     8,     3
};
...
#line 43 "parser.y"
    {
				int i=(int)(yyvsp[(2) - (6)].dval);
				//printf("GXY G%.0f X nach %.4f Y nach %.4f\n",$2,$4,$6);
				switch(i)
				{
					case 0:
						printf("schneller Vorschub nach %f/%f\n",(yyvsp[(4) - (6)].dval),(yyvsp[(6) - (6)].dval));
						mySetStepDelay(500);
						mygoto((yyvsp[(4) - (6)].dval),(yyvsp[(6) - (6)].dval));
						break;
					case 1:
					case 2:
					case 3:
